...
namespace DSPACardio.Web.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Street,City")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Street,City")] Hospital hospital)
        {
            if (id != hospital.Id)
            {
                return NotFound();
